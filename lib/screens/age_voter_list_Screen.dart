...
class AgeVoterListScreen extends StatefulWidget {
  final String ageGroup;
  const AgeVoterListScreen({super.key, required this.ageGroup});

  @override
  State<AgeVoterListScreen> createState() => _AgeVoterListScreenState();
}

class _AgeVoterListScreenState extends State<AgeVoterListScreen> {
  ...
  Future<void> fetchVoters({bool reset = false}) async {
    ...
    final url =
        "http://api.aoinfotech.com/api/GetVotersByAge?pageindex=$pageIndex&pagesize=$pageSize&AgeGroup=${widget.ageGroup}&Search_Data=$searchQuery";
  ...
  String removeUnderscores(String key) {
    return key.replaceAll(
      '_',
      ' ',
    ); // You can replace with language provider if needed
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Voters (${widget.ageGroup})"),
