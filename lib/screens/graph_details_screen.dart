...
class GraphDetailsScreen extends StatefulWidget {
  final String title;
  const GraphDetailsScreen({super.key, required this.title});

  @override
  State<GraphDetailsScreen> createState() => _GraphDetailsScreenState();
}

class _GraphDetailsScreenState extends State<GraphDetailsScreen> {
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Experience the vibrant urban nightlife',
